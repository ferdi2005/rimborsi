class BankAccountsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @bank_account.save
        format.html { redirect_to @bank_account, notice: t("controllers.bank_accounts.create_success") }
  ...
  def update
    respond_to do |format|
      if @bank_account.update(bank_account_params)
        format.html { redirect_to @bank_account, notice: t("controllers.bank_accounts.update_success") }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to bank_accounts_path, status: :see_other, notice: t("controllers.bank_accounts.delete_success") }
