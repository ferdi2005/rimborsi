class ExpensesController < ApplicationController
  ...
  private
    ...
    def expense_params
      params.require(:expense).permit(:reimboursement_id, :purpose, :project, :date, :amount, :requested_amount, :car, :calculation_date, :departure, :arrival, :distance, :return_trip, :vehicle_category_id, :brand, :model, :fuel_id, :quota_capitale, :carburante, :pneumatici, :manutenzione, :fund_id, attachments: [])
    end
end
