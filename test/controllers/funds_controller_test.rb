...
class FundsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create fund" do
    assert_difference("Fund.count") do
      post funds_url, params: { fund: { active: true, budget: 1000.0, name: "Nuovo fondo" } }
    end
  ...
  test "should update fund" do
    patch fund_url(@fund), params: { fund: { active: @fund.active, budget: @fund.budget, name: "Fondo aggiornato" } }
